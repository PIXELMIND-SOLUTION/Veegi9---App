...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _loadSavedCredentials() async {
    // You can implement UserPreferences loading here if needed
              ...
              Row(
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 14, 
                      color: authProvider.isLoading ? Colors.grey[400] : Colors.grey,
                    ),
                  ),
                ],
              ),
                  ...
                  WidgetSpan(
                    child: GestureDetector(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 14,
                          color: authProvider.isLoading ? Colors.grey[400] : Colors.blue,
                          decoration: authProvider.isLoading ? null : TextDecoration.underline,
                        ),
                      ),
                    ),
  ...
  void _handleLogin(AuthProvider authProvider) async {
    ...
    // The provider will handle navigation to MainScreen on success
  }

  void _handleForgotPassword(AuthProvider authProvider) async {
    // Show input dialog for phone number
    String? phoneNumber = await _showForgotPasswordDialog();
    
    if (phoneNumber != null && phoneNumber.isNotEmpty) {
      // Clear any previous errors
      authProvider.clearError();
      
      // Call the forgotPassword method from AuthProvider
